                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                ...
                                <?php echo form_open_multipart('AdminController/add_newsevents'); ?>
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="news_title" placeholder="enter title" class="form-control input-height" value="<?php echo set_value('news_title')?>" />
                                             ...
                                             <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea name="news_desc" placeholder="enter description" class="form-control-textarea" id="textabc" rows="5" ><?php echo set_value('news_desc') ?></textarea>
