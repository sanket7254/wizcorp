...
<!-- Mirrored from radixtouch.in/templates/admin/smart/source/light/tableData.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Aug 2018 12:38:37 GMT -->
<head>
    <meta charset="utf-8" />
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-white white-sidebar-color logo-indigo">
    <div class="page-wrapper">
        ...
        <div class="quick-setting-main">
			...
			<div class="quick-setting display-none">
				...
				<a href="http://radixtouch.in/templates/admin/smart/source/dark/tableData.html" data-theme="dark"><span class="head"></span><span class="cont"></span></a>
				</div></li>	
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Table With Javascript Data</div>
                            </div>
    ...
    <!-- data tables -->
    <script src="<?php echo base_url();?>assets/Frontend/new-plugins/plugins/datatables/jquery.dataTables.min.js" ></script>
